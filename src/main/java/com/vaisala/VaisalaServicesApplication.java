...
public class VaisalaServicesApplication {

    private static final Logger log = LoggerFactory.getLogger(VaisalaServicesApplication.class);

    public static void main(String[] args) {
		final SpringApplication app = new SpringApplication(VaisalaServicesApplication.class);
        final ApplicationContext ctx = app.run(VaisalaServicesApplication.class, args);
	...
	public DataSource dataSource() {
		...
		dsProps.setProperty("url", "jdbc:mysql://127.0.0.1:3306/vaisala?connectionTimeout=60000&socketTimeout=60000&autoReconnect=true&useUnicode=yes&characterEncoding=UTF-8");
		...
		ds.setPoolName("Vaisala Connection Pool");
